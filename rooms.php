...
//to calc row
$totalRoom = mysqli_num_rows($resulRoom); 

//formula to get how many page in pagination
$totalPage = ceil($totalRoom / $num_per_page); 
        ...
        <div class="content">
            <div class="listing card">
                <div class="table-header collapses">
                    ...
                    </div><!--end of button to more page -->
                </div>
